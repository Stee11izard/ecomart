        ...
        "<div class=\"container-fluid\">" +
            ...
            "<div class=\"collapse navbar-collapse justify-content-end me-4\" id=\"navbarContent\">" +
                "<ul class=\"navbar-nav\">" +
                    ...
                    "</li>" +
                    "<li class=\"nav-item ms-4\">" +
                        "<a href=\"aboutus.html\" class=\"nav-link\">МЫ</a>" +
                    "</li>" +
                    "<li class=\"nav-item ms-4\">" +
                        "<a href=\"delivery.html\" class=\"nav-link\">ДОСТАВКА</a>" +
                    "</li>" +
                    "<li class\"nav-item ps-5\">" + 
                        "<a href=\"userPage.html\" class=\"nav-link\"><img src=\"../../images/user.svg\"</a>" +
                    "</li>" +
                    "<li class\"nav-item ps-5\">" + 
                        "<a href=\"cartPage.html\" class=\"nav-link\"><img src=\"../../images/shopping-cart.svg\"</a>" +
                    "</li>" +
                "</ul>" +
            "</div>" +
        "</div>" +
